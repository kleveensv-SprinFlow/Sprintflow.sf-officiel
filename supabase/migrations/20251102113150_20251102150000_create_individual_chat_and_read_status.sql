/*
  ...
  2. Sécurité
    ...
    - Policies pour gérer les accès aux messages et statuts de lecture

  3. Fonction RPC
    - `get_user_conversations()` : Récupère toutes les conversations (groupes + individuelles)
      avec le nombre de messages non lus pour chaque conversation
*/
...
CREATE POLICY "Users can exchange private messages"
...
-- 3. Créer la fonction RPC pour récupérer toutes les conversations
