...
type ActionView = null | 'new-workout' | 'new-record' | 'my-follow-ups' | 'my-athletes-360' | 'manage-planning' | 'exercise-library';
      ...
      <div className="min-h-screen bg-sprint-light-background dark:bg-sprint-dark-background text-sprint-light-text-primary dark:text-sprint-dark-text-primary flex flex-col overflow-hidden">
        ...
        >
          <AnimatePresence mode="wait">
            ...
            {mainView === 'dashboard' && activeAction === 'exercise-library' && (
              <motion.div key="exercise-library" initial="initial" animate="in" exit="out" variants={pageVariants} transition={pageTransition}>
