...
export default function CoachHeader({ currentView, onNavigate, isLoading }: CoachHeaderProps) {
    ...
    if (currentView === 'dashboard') {
      return (
        <h1 className="text-xl font-extrabold text-gray-900 dark:text-white font-manrope tracking-tight">
          SPRINTFLOW <span className="text-xs font-normal text-gray-500">Coach</span>
        </h1>
      );
    }
    return (
